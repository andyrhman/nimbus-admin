...
import SelectTabProvinsi from "@/components/SelectTab/SelectTabProvinsi.js";
...
const TempatWisataProvinsi = () => {
    ...
    const [selectedProvinsi, setSelectedProvinsi] = useState('Yogyakarta');
    ...
    useEffect(() => {
        const fetchTempatWisata = async () => {
            ...
            try {
                const { data } = await axios.get(`user/tempat-wisata/provinsi/${selectedProvinsi}`, {
        ...
        fetchTempatWisata();
    }, [searchTerm, page, router, selectedProvinsi]);
    ...
    return (
        <Layout>
            ...
            <DefaultLayout>
                ...
                <SelectTabProvinsi onSelectProvinsi={setSelectedProvinsi} />

...
const CategoryWisata = () => {
    ...
    useEffect(() => {
        (
            async () => {
                try {
                    const { data } = await axios.get('user/category-wisata');
    ...
    const [categoryWisataId, setCategoryWisataId] = useState(null);
                ...
                <div className="flex flex-col gap-10">
                    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                        <div className="flex items-center justify-between mb-3">
                            <Link href={'/category-wisata/create'} className="inline-flex items-center justify-center rounded-md bg-primary px-2 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-2 xl:px-2">
                                Tambah Category
                            </Link>
                        </div>
                        <div className="max-w-full overflow-x-auto">
                            {categoryWisata.length > 0 ? (
                                <table className="w-full table-auto">
                                    ...
                                    <tbody>
                                        {categoryWisata.slice(page * perPage, (page + 1) * perPage).map((cw, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                    <div className="flex items-center space-x-3.5">
                                                        <Link href={`/category-wisata/edit/${cw.id}`} className="hover:text-primary">
                                                        ...
                                                        <button className="hover:text-primary" onClick={() => del(cw.id)}>
                                                            <svg

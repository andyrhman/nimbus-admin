...
const EditCategory = () => {
    ...
    useEffect(() => {
        if (id) {
            (
                async () => {
                    try {
                        const { data } = await axios.get(`admin/category-wisata/${id}`);
                        setNama(data.nama);
    ...
    const updateCategory = async (e) => {
        ...
        try {
            await axios.put(`admin/category-wisata/${id}`, {
                nama,
                thumbnail
            });
        ...
        <Layout>
            ...
            <DefaultLayout>
                <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <Link href="/category-wisata" className="flex items-center space-x-2">

...
const CreateTempatWisata = () => {
    ...
    const [dekripsi, setDeskripsi] = useState('');
    ...
    const [averate_rating, setAverageRating] = useState('');
    ...
    const handleFileChange = (e) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setThumbnail(file); // Store the selected file in state
        }
    };
    ...
    const submit = async (e) => {
        ...
        try {
            const { data } = await axios.post('admin/tempat-wisata', {
                nama,
                thumbnail,
                dekripsi,
                alamat,
